...
namespace IStudyKindergartens.Repositories
{
    public interface IStatementManager
    {
        ...
        List<StatementListItemViewModel> GetFormatStatementListViewModel(string userId = "none", bool isKindergarten = false, string status = "none", bool isAll = false);
    }
    ...
    public class StatementManager : IDisposable, IStatementManager
    {
        ...
        public List<StatementListItemViewModel> GetFormatStatementListViewModel(string userId = "none", bool isKindergarten = false, string status = "none", bool isAll = false)
        {
            ...
            for (int i = 0; i < statements.Count; i++)
            {
                ...
                tempStringId = statements[i].KindergartenId;
                model.Add(new StatementListItemViewModel
                {
                    KindergartenName = db.Kindergartens.Where(k => k.Id == tempStringId).First().Name,
