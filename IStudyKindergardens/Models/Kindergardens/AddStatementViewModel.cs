...
namespace IStudyKindergardens.Models
{
    public class AddStatementViewModel
    {
        ...
        [Display(Name = "SelectedKindergardenId")]
        public string SelectedKindergardenId { get; set; }

        [Display(Name = "Kindergardens")]
        public SelectList Kindergardens { get; set; }

        [Required(ErrorMessage = "Вкажіть адресу проживання!")]
        [Display(Name = "KindergardenId")]
